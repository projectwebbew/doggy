        ...
        <div class="row">
            <div class="col-md-9 py-5">
                <div class="row">
                    <div class="col-md-4 mb-md-0 mb-4">
                        ...
                        <p style="color: rgba(0,0,0,.3);">A small river named Duden flows by their place and supplies it with the necessary
                            regelialia.</p>
                        <ul class="ftco-footer-social p-0">
                            <li class="ftco-animate"><a href="#" data-toggle="tooltip" data-placement="top" title=""
                                                        data-original-title="Twitter"><span
                                        class="ion-logo-twitter"></span></a></li>
                            <li class="ftco-animate"><a href="#" data-toggle="tooltip" data-placement="top" title=""
                                                        data-original-title="Facebook"><span
                                        class="ion-logo-facebook"></span></a></li>
                            <li class="ftco-animate"><a href="#" data-toggle="tooltip" data-placement="top" title=""
                                                        data-original-title="Instagram"><span
                ...
                <div class="row mt-md-5">
                    <div class="col-md-12">
                        <p class="copyright" style="color: rgba(0,0,0,.3);">
                            Copyright ©
                            <script>document.write(new Date().getFullYear());</script>
                            2022 All rights reserved | This template is made with <i class="ion-ios-heart"
            ...
            <div class="col-md-3 py-md-5 py-4 aside-stretch-right pl-lg-5">
                ...
                <form action="#" class="contact-form ">
                    ...
                    <div class="form-group p-1">
                        <button type="submit" class="btn btn-primary     form-control submit px-3">Send</button>
                    </div>
                </form>
            </div>
        </div>
