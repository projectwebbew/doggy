    ...
    <section class="section_slider ">
        <div class="dog-container" style="position: relative">
            ...
            <div class="asd">
                ...
                <div class="review_field"> <div class="rev">
                    @foreach($reviews as $review)
                        <div style="padding: 10px;">
                            <div class="r_box">
                                <div class="usCont">
                                    <div class="usName">{{ $review->user->name }}</div>
                                    <div class="usPhoto"></div>
                                </div>
                                <div class="user_text_cont">
                                    <div class="us_text">{{ $review->review }}
                                    </div>
                                    @if(Auth::user() && Auth::user()->id == $review->user->id)
                                        <div class="forms_cont">
                                            <div class="us_icon us_delet"><i class="demo-icon icon-cancel-circled"></i>
                                            </div>
                                            <div class="us_icon us_edit"><i class="demo-icon icon-pencil"></i></div>
                                        </div>
                                    @else
                                        <div class="forms_cont_empty"></div>
                                    @endif
                                </div>
                            </div>
                    </div>
                ...
                @if(Auth::user() && Auth::user()->user_status_id === 1)
                    <div>
                        <form action="{{route('slider.review',$dog)}}" method="GET">
                            @csrf
                            <div class="container d-flex justify-content-center mt-5">
                                <div class="card p-3" style="width: 70%">
                                    <div class="form" id="form">
                                        ...
                                        <div class="form mt-3">
                                        <textarea name="review" class="form-control mt-2 text-area" rows="4"
                                                  placeholder="Review" id="feedback"></textarea>
                                        </div>
                                        <div class="mt-2">
                            ...
                            <input name="dog_id" type="hidden" value="{{ $dog->id }}">
                        </form>
                    </div>
                @else
